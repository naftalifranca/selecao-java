...
public interface PriceHistoricRepository extends JpaRepository<PriceHistoric, Long>{
    ...
    @Query("select h from PriceHistoric h where h.regiaoSigla = UPPER(:regiaoSigla)")
    Page<PriceHistoric> listByRegiaoSigla(@Param("regiaoSigla") String regiaoSigla, Pageable pageSize);
